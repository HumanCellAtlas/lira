...
def post(body):
    ...
    logger.info("-=-=-=-=-=")
    logger.info(cromwell_labels)
    logger.info("---------- Step 6 ----------")
    cromwell_labels_file = json.dumps(cromwell_labels)
    logger.info("-=-=-=-=-=")
    logger.info(cromwell_labels_file)
