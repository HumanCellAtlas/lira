...
def create_prepare_submission_function(cache_wdls):
    ...
    def prepare_submission(wdl_config, submit_wdl):
        ...
        logger.info("=================")
        logger.info("->WDL<-")
        logger.info(wdl_config.wdl_link)
        logger.info("=================")
        wdl_file = cromwell_tools.download(wdl_config.wdl_link)
        logger.info("=================")
        logger.info("->WDL File<-")
        logger.info(wdl_file)
        logger.info("=================")
        logger.info("=================")
        logger.info("->wdl_static_inputs_file<-")
        logger.info(wdl_config.wdl_static_inputs_link)
