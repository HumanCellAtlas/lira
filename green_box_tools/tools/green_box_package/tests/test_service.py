...
from green_box.api.utils import *
from green_box.api import health
...
class TestService(unittest.TestCase):
    ...
    def test_is_authenticated_no_auth_header(self):
        self.assertEquals(is_authenticated({'foo': 'bar'}, 'baz'), False)

    def test_is_authenticated_wrong_auth_value(self):
        self.assertEquals(is_authenticated({'auth': 'bar'}, 'foo'), False)

    def test_is_authenticated_valid(self):
        self.assertEquals(is_authenticated({'auth': 'bar'}, 'bar'), True)
