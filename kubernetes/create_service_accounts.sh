...
# Variables
LIRA_ENVIRONMENT=${LIRA_ENVIRONMENT:-"test"}
...
# ECHO VALUES
echo "CAAS_ENV:             ${CAAS_ENVIRONMENT}
SAM_ENVIRONMENT:            ${SAM_ENVIRONMENT}
ENVIRONMENT:                ${LIRA_ENVIRONMENT}
GCLOUD_PROJECT:             ${GCLOUD_PROJECT}
VAULT_TOKEN_PATH:           ${VAULT_TOKEN_PATH}
WORKFLOW_COLLECTION_ID:     ${WORKFLOW_COLLECTION_ID}
SERVICE:                    ${SERVICE}
FIRECLOUD_USER_GROUP_NAME:  ${FIRECLOUD_USER_GROUP_NAME}
FIRECLOUD_API_URL:          ${FIRECLOUD_API_URL}
SAM_URL:                    ${SAM_URL}
SVC_ACCOUNT_NAME:           ${SVC_ACCOUNT_NAME}
SVC_ACCOUNT_EMAIL:          ${SVC_ACCOUNT_EMAIL}
SVC_ACCOUNT_KEY:            ${SVC_ACCOUNT_KEY}
SVC_ACCOUNT_VAULT_KEY_PATH: ${SVC_ACCOUNT_VAULT_KEY_PATH}"
