...
def start_workflow(wdl_file, zip_file, inputs_file, inputs_file2, options_file, green_config):
    ...
    :param _io.BytesIO or file-like object wdl_file: wdl file.
    :param _io.BytesIO or file-like object zip_file: zip file.
    :param _io.BytesIO or file-like object inputs_file: inputs file.
    :param _io.BytesIO or file-like object inputs_file2: inputs file 2.
    :param _io.BytesIO or file-like object options_file: configs file.
